...
<div class="row mb-3">
    <label for="inp_tip" class="col-sm-2 col-form-label">Fatura Tipi</label>
    <div class="col-sm-10">
<select  name="kayit_tip" class="form-select" aria-label="Default select example">
  ...
  <div class="row mb-3">
    <label for="inp_ckod" class="col-sm-2 col-form-label">Vadesi</label>
    <div class="col-sm-10">
      <input type="date" name="vadesi" class="form-control" id="vadesi">
    </div>
  </div>
...
if(isset($_POST['kaydet'])) {
        ...
        if ($kayit_tip==1) {
            ...
            $alacak=0;
                ...
                carihrk (tarih,belge_no,vadesi,aciklama,kayit_tip,borc,alacak,ckod_id) 
                VALUES ('$tarih','$belge_no','$vadesi','$aciklama','$kayit_tip','$borc','$alacak',$ckod_id)";
